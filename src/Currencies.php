...
{
    /**
     * @link https://gist.github.com/ArrayIterator/93a45f827dce8fe0b080da72d5805fc7
     * @var array
     */
     ...
     * @return array|null
     */
    public static function get(string $currencyCode, bool $useDefault = true) : ?array
    {
        $currencyCode = trim(strtoupper($currencyCode));
        return self::CURRENCIES[$currencyCode]??($useDefault ?[
            'code' => $currencyCode,
            'name' => '',
            'symbol' => ''
        ]:null);
