 ...
 */
class BankMandiri extends AbstractProvider
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected $providerName = 'Bank Mandiri Special Rate';

    /**
     * @var string
     */
    protected $providerUrl = 'https://www.bankmandiri.co.id/';

    /**
     * @var string
     */
    protected $ratesUrl = 'https://www.bankmandiri.co.id/kurs';
    ...
    public function getRates(): Rates
    {
        ...
        try {
            ...
            $tbody = $body->filter('.portlet .portlet-body table.table-kurs tbody tr');
            if (!$tbody->count()) {
                unset($tbody);
                return $this->rates;
            }
