 ...
 */
class BankPanin extends AbstractProvider
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected $providerName = 'Bank Panin';

    /**
     * @var string
     */
    protected $providerUrl = 'https://www.panin.co.id/';

    /**
     * @var string
     */
    protected $ratesUrl = 'https://www.panin.co.id/pages/currency';
    ...
    public function getRates(): Rates
    {
        ...
        try {
            ...
            $tbody = $body->filter('#Kurs table tr');
            if (!$tbody->count()) {
                unset($tbody);
                return $this->rates;
            }
