 ...
 */
class BankDanamon extends AbstractProvider
{
    /**
     * @var string
     */
    protected $providerCode = 'Danamon';

    /**
     * @var string
     */
    protected $providerName = 'Bank Danamon Indonesia';

    /**
     * @var string
     */
    protected $providerUrl = 'https://www.danamon.co.id/';

    /**
     * @var string
     */
    protected $ratesUrl = 'https://www.danamon.co.id/id/Kurs-Details';
    ...
    public function getRates(): Rates
    {
        ...
        try {
            ...
            $tbody = $body->filter('#content-wrapper table.kurs-detail tr');
            if (!$tbody->count()) {
                unset($tbody);
                return $this->rates;
            }
            $tbody->each(function (HtmlPageCrawler $crawler) {
                ...
                $buy = trim($td->eq(1)->text());
                $sell = trim($td->eq(2)->text());
