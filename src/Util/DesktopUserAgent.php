...
namespace ArrayIterator\ProjectModule\CurrencyRates\Util;
 ...
 * @package ArrayIterator\ProjectModule\CurrencyRates\Util
 */
class DesktopUserAgent
{
    ...
    // EDGE ( change on new versions)
    // Microsoft Edge using blink
    // @https://www.microsoft.com/en-us/edge
    // const MAX_VERSION_EDGE  = 18;
    // const MIN_VERSION_EDGE  = 12;
    const MAX_VERSION_EDGE  = 80; // 82 future relase beta
    const MIN_VERSION_EDGE  = 79;
    // CHROME
    const MAX_VERSION_CHROME  = 80;
    const MIN_VERSION_CHROME  = 60;
    // FIREFOX
    const MAX_VERSION_FIREFOX  = 74;
    const MIN_VERSION_FIREFOX  = 60; // prev 50
    // OPERA
    ...
    protected $macOSMaxVersionLists = [
        ...
        self::VERSION_MAC_OS_CATALINA => 3,
    ];
